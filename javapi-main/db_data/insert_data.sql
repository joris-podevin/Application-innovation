...
insert into cours (matiere, salle, section, groupe, date_debut, date_fin, professeur) values ('application d innovation', 'c137', 'm2 sicom', 'alternant', '2023-11-16 08:30:00', '2023-11-16 11:30:00', 'philippe');
insert into cours (matiere, salle, section, groupe, date_debut, date_fin, professeur) values ('securite des services web', 'c136', 'm2 sicom', 'classique', '2023-11-16 08:30:00', '2023-11-16 11:30:00', 'jane');

insert into cours (matiere, salle, section, groupe, date_debut, date_fin, professeur) values ('architecture web', 'c138', 'm1 sicom', 'classique', '2023-11-16 10:00:00', '2023-11-16 11:30:00', 'philippe');
insert into cours (matiere, salle, section, groupe, date_debut, date_fin, professeur) values ('architecture cloud', 'c138', 'm1 sicom', 'classique', '2023-11-16 13:00:00', '2023-11-16 16:00:00', 'robert');

insert into cours (matiere, salle, section, groupe, date_debut, date_fin, professeur) values ('design pattern', 'c137', 'l3 informatique', 'alternant', '2023-11-16 14:30:00', '2023-11-16 17:30:00', 'philippe');
insert into cours (matiere, salle, section, groupe, date_debut, date_fin, professeur) values ('protocoles reseaux', 'c136', 'l3 informatique', 'classique', '2023-11-16 16:00:00', '2023-11-16 19:00:00', 'jane');

insert into cours (matiere, salle, section, groupe, date_debut, date_fin, professeur) values ('toxicologie', 'a01', 'm1 hse', 'classique', '2023-11-16 08:30:00', '2023-11-16 11:30:00', 'bernard');
insert into cours (matiere, salle, section, groupe, date_debut, date_fin, professeur) values ('microbiologie', 'amphi blaise', 'm1 hse', 'classique', '2023-11-16 13:00:00', '2023-11-16 16:00:00', 'bernard');

insert into cours (matiere, salle, section, groupe, date_debut, date_fin, professeur) values ('teledetection', 'c138', 'm1 hse', 'classique', '2023-11-16 08:30:00', '2023-11-16 10:00:00', 'chi');
insert into cours (matiere, salle, section, groupe, date_debut, date_fin, professeur) values ('hydrogeophysique', 'a02', 'm2 hse', 'classique', '2023-11-16 13:00:00', '2023-11-16 16:00:00', 'chi');


(matiere, salle, section, groupe, dateDebut, dateFin, professeur)
